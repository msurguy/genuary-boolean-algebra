...
export const PERM_MOD12 = new Uint8Array(512);
for (let i = 0; i < 512; i++) {
  PERM[i] = p[i & 255];
...
// Compute gradient dot product for 2D
export function grad2d(hash, x, y) {
  const g = GRAD2[hash & 7];
  return g[0] * x + g[1] * y;
}

// 3D gradient vectors for simplex noise (12 directions)
export const GRAD3 = [
...
// Simplex skewing factors for 2D
